...
import com.virusoft.draculahrm.controller.dashboard.DashboardController;
...
//    }
    ...
    public void loginButtonOnClick(ActionEvent event) {
        ...
        if (!usernameTextField.getText().isBlank() && !passwordPasswordField.getText().isBlank()) {
            try {
                ...
                String FXMLPath = "/com/virusoft/draculahrm/view/dashboard/dashboard.fxml";
                ...
                String CCSPath = "/com/virusoft/draculahrm/css/styles.css";
    ...
    public void forgetyourpasswordLabelOnMouseClicked(MouseEvent event) {
        ...
        try {
            //Load the FXML file
            String FXMLPath = "/com/virusoft/draculahrm/view/auth/forgot-your-password-view.fxml";
